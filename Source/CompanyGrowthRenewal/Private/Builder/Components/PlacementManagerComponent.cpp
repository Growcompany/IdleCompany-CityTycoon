#include "Builder/Components/PlacementManagerComponent.h"
#include "Kismet/GameplayStatics.h"
#include "Kismet/KismetMathLibrary.h"
#include "Camera/CameraComponent.h"
#include "Builder/Actors/PlacementActor.h"
#include "Builder/Actors/GridManager.h"
...
bool UPlacementManagerComponent::CheckUnderCursorForSelection()
{
	...
	FHitResult h;
	if (GetPlayerController()->GetHitResultUnderCursor(ECC_WorldStatic, 0, h)) { // ECC_WorldStatic
